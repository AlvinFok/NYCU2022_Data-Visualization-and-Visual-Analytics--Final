...
with open('../../cleaned/legislator/2020/candidate.csv', 'w', newline='', encoding="utf-8") as csvfile:
...
with open('../../cleaned/legislator/2020/by_district.csv', 'w', newline='', encoding="utf-8") as csvfile:
    writer = csv.writer(csvfile)
